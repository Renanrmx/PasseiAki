...
- [Arquitetura da extensão](docs/pt-br/architecture.md)
- [Persistência, privacidade e modelo de dados](docs/pt-br/persistence-and-data-model.md)
- [Matching, mirrors e normalização de domínios](docs/pt-br/matching-and-mirrors.md)
- [Backup, restauração, importação e exportação](docs/pt-br/backup-import-export.md)
- [Testes, lint e build](docs/pt-br/testing-build.md)

Para mudanças simples de UI, comece por [Arquitetura da extensão](docs/pt-br/architecture.md) e [Testes, lint e build](docs/pt-br/testing-build.md).
